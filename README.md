Lane_departure_warning_system.py file contains python code for detection of lane and prediction of an angle. Which is deviation from the center of the lane. 
